...
#' Not using meters.per.degree.lon() the results would be roughly ( 1 / ((pi/180) * 6378.137 * cos(lat * 0.01745329)) )
...
#'   and \code{\link{get.distances}} for get.distances() which allows you to specify a search radius and 
